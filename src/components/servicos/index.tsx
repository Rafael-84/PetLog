            ...
            <section className="w-full bg-[url(../../src/assets/bgbody-petlog.png)] bg-cover bg-blend-overlay bg-purple-200 ">
                <Container>
                    ...
                    <div className="pt-20 pb-36">
                        <div className="absolute left-0  bg-[url(../../src/assets/cardimage.png)] bg-cover bg-blend-overlay bg-[#e7bfff] w-auto px-1 py-3 rounded-r-full shadow-[#330F47] shadow-xs z-10 md:px-14">
                            <h4 className=" text-center text-purple-950 font-mochiy text-xs">Confira Nossos Serviços e Produtos</h4>
                        </div>
                    </div>

                    <div className='grid grid-cols-2 gap-24 pb-32 w-full mx-auto md:flex md:items-center md:justify-center'>
                        <div className='flex flex-col text-center'>
                            <Link to="/banhoetosa" >
                                <div className='flex flex-col gap-2 w-20 '>
                                    <img className=' w-full ' src={serviceTosa} alt="" /><p className='text-baseMenuText font-bold font-poppins'>Banho e Tosa</p>
                                </div>
                            </Link>
                        </div>
                        <div className='flex flex-col text-center'>
