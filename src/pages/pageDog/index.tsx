...
export function PageDog() {
    ...
    return (
        <main >
            <section className="w-full bg-[url(../../src/assets/bg-dog.png)] bg-contain bg-no-repeat bg-blend-overlay bg-white/70">
                <Container>
                    <div className="w-full flex  items-center justify-center gap-4">
                        <LuBone size={24} color="#CA4E00"/>
                        <h1 className="py-24 text-[#CA4E00] font-mochiy text-xl">Cachorros</h1>
                        <LuBone size={24} color="#CA4E00"/>
                    </div>
