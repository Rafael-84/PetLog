...
export function PageDog() {
    ...
    const [produtoRacoesDog, setProdutoRacoesDog] = useState<ProductProps[]>([]);
    const [produtoBrinquedoDog, setProdutoBrinquedoDog] = useState<ProductProps[]>([]);
    const [produtoHigieneDog, setProdutoHigieneDog] = useState<ProductProps[]>([]);

    return (
        <main >
            <section className="w-full md:bg-[url(../../src/assets/bg-dog.png)] md:bg-contain md:bg-no-repeat md:bg-blend-overlay md:bg-white/70">
                <Container>
                    <div className="w-full flex  items-center justify-center gap-4 py-10 md:py-24">
                        <LuBone size={24} color="#CA4E00"/>
                        <h1 className=" text-[#CA4E00] font-mochiy text-xl">Cachorros</h1>
                        <LuBone size={24} color="#CA4E00"/>
                    </div>
