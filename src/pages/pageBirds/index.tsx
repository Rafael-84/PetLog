...
export function PageBirds() {
    ...
    const [produtoRacoeBird, setProdutoRacoeBird] = useState<ProductProps[]>([]);
    const [produtoBrinquedoBird, setProdutoBrinquedoBird] = useState<ProductProps[]>([]);
    const [produtoHigieneBird, setProdutoHigieneBird] = useState<ProductProps[]>([]);
