...
export function PageCat() {
    ...
    return (
        <main >
            <section className="w-full bg-[url(../../src/assets/bg-cat.png)] bg-contain bg-no-repeat bg-blend-overlay  bg-white/85">
                <Container>
                    <div className="w-full flex  items-center justify-center gap-4">
                        <GiCannedFish size={24} color="#036454"/>
                        <h1 className="py-24 text-[#00937A] font-mochiy text-xl">Gatos</h1>
                        <GiCannedFish size={24} color="#036454"/>
                    </div>
